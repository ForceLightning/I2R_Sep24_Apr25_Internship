# -*- coding: utf-8 -*-
"""Uncertainty ResNet-50 adaptations."""

from __future__ import annotations

# Standard Library
from typing import Any, Callable, List, Optional, Type, Union, override
...
from torchvision.models.resnet import BasicBlock as BasicBlockBase
from torchvision.models.resnet import Bottleneck as BottleneckBase
...
class BasicBlock(BasicBlockBase):
    """BasicBlock of ResNet with dropout."""
...
class Bottleneck(BottleneckBase):
    """Bottleneck of ResNet with dropout."""
...
class ResNet(ResNetBase):
    """ResNet base model with dropout."""
    ...
    def __init__(
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], dropout_p=dropout_p)
    ...
    @override
    def _make_layer(  # pyright: ignore[reportIncompatibleMethodOverride]
        self,
        block: Type[Union[BasicBlock, Bottleneck]],
        planes: int,
        blocks: int,
...
class ResNetEncoder(ResNet, EncoderMixin):
    """Modified ResNet encoder for Segmentation Models Pytorch with dropout."""
    ...
    def get_stages(self) -> list[nn.Module]:
        """Get the stages of the encoder."""
        return [
            nn.Identity(),
            nn.Sequential(self.conv1, self.bn1, self.dropout, self.relu),
